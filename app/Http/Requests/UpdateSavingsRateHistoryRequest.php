...
/**
 * Beda dari AddSavingsRateHistoryRequest: ini MENGOREKSI baris tarif yang
 ...
 * untuk menambah baris baru lewat AddSavingsRateHistoryRequest — lihat
 * TarifParameterController::addSavingsRate() vs updateSavingsRate()).
 *
 * @return array<string, ValidationRule|array<mixed>|string>
 */
class UpdateSavingsRateHistoryRequest extends FormRequest
{
