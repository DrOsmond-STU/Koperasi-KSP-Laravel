...
@section('content')
    ...
    <div class="panel">
        <form method="POST" action="{{ route('staf.teller.buka-rekening.store') }}">
            ...
            <div class="field">
                <label>Rekening Kas (untuk setoran awal)</label>
                ...
                <p class="field-hint">
                    Default akun kas cabang KSP. Kalau ada setoran awal, transaksinya diposting ke
                    akun kas ini — ganti kalau memang harus posting ke akun lain.
                </p>
            </div>
